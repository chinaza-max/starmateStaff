  ...
  function handlefileUplaod(event) {
    ...
    if (selectedFile.type.split('/').includes('image')) {
      ...
      reader.onload = function (e) {
        ...
        Swal.fire({
          html: `<iframe  width="auto"  src="${videoURL}" frameborder="0" autoPlay="false"  allowfullscreen></iframe>`,
          confirmButtonColor: 'green',
          confirmButtonText: 'upload',
          cancelButtonText: 'Cancel',
...
*/
  ...
  useEffect(() => {
    scrollToBottom()
    moveToTopRef.current.scrollIntoView({
      behavior: "smooth",
      block: "start"
    })
  }, [chats, open])
  ...
  return (
    <div className='Report' ref={moveToTopRef}>
      <React.Fragment>
        <CssBaseline />
        ...
        <div className='Report'>
          ...
          <input type='file' style={{ display: 'none' }} ref={fileInputRef} onChange={handlefileUplaod} />
              ...
              <Box className='inputSection' sx={{ p: 2 }} color='primary'>
                <Grid container spacing={2}>
                  <Grid item xs={2}>
                    ...
                    >
                      <RadialMenu
                        isRecordingHndleP={isRecordingHndle}
                        startRecordingHandlerP={startRecordingHandler}
                        handleIconClickP={handleIconClick}
                        openP={open}
                      />
                    </div>
                  </Grid>
      ...
      >
        ...
        >
          {type === 'text' ? (
            ...
            <div className='imageContainer'>
              <iframe src={message.url} title='image'></iframe>
            </div>
          )}
        </Paper>
      </Box>
